    ...
    <div className="min-h-screen w-[100vw] flex items-center justify-center bg-cover bg-center loginBackgroundImage">
      <div className="bg-opacity-0 backdrop-blur-xl p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            ...
            <input
              ...
              required
              className="w-[90%] ml-4 py-3 text-white border-b-2 border-opacity-30 backdrop-blur-2xl bg-transparent focus:outline-none focus:border-opacity-100 bg-opacity-10"
        ...
        <p className="text-center text-purple-400 text-md pb-2 mt-4">
          Already have an account? <a href="/" className="text-purple-200 hover:underline">Log In</a>
        </p>
      </div>
    </div>
  );
