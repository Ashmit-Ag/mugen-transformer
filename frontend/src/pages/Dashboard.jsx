      ...
      <div className="containers bg-gray-700 w-full flex flex-col items-center gap-12 py-16">
        ...
        <div className="w-full  z-10 h-[70vh] flex flex-col justify-center items-center text-center">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6">
            Welcome to
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-500 via-indigo-500 to-pink-600">
              {" "}
              MuGen AI
            </span>
          </h1>
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            <Link
              to="/generate"
              className="gradient-butto bg-[#040b13a8] text-white py-2 px-4 rounded-md border-white border-2"
            >
              Generate Music
            </Link>
            <Link
            ...
            <button className="neon-button">Generate Music</button>
